...
# Declaring Constants
src_dir = r"I051_02"
dst_dir = r"G:\mash_dataset\I051_02_sr"
...
for parent_dir, _, files in os.walk(src_dir):
        for fname in files:
            ...
            dst_path = os.path.join(dst_dir, parent_dir)
            if not os.path.exists(dst_path): os.makedirs(dst_path)
            final_path = os.path.join(dst_path, fname)
            ...
            save_image(fake_image, filename=final_path)
